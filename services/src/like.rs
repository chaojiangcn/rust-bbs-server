...
pub async fn like(db: &DbConn, param: Json<AddLikeReq>) -> Result<Json<Response<Value>>, ErrorResponder> {
...
pub async fn unlike(db: &DbConn, param: Json<AddUnLikeReq>) -> Result<Json<Response<Value>>, ErrorResponder> {
